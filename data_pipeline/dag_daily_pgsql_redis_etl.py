...
def dag_batch_bs():
    ...
    start_task >> update_credit_info_from_mongo >> update_credit_info_into_pgsql
    update_credit_info_into_pgsql >> [update_ptt_title_into_redis, update_ptt_articles_into_redis, update_ptt_popular_articles_into_redis] >> end_task
